...
class GUI(QMainWindow):
    def __init__(self):
        ...
        self.imu_layout.addWidget(self.imulabel)
        ...
        self.imu_layout.addWidget(self.plot)
    ...
    def imucallback(self,data):
        ...
        roll,pitch,yaw = to_euler_angles(self.imu_msg[0],self.imu_msg[1],self.imu_msg[2],self.imu_msg[3])
